				...
				<div class="title">
					...
					<nav aria-label="breadcrumb" role="navigation">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="?mnu=sprofile">Profile</li>
						</ol>
					</nav>
			</div>
		</div>
													...
													<ul class="profile-edit-list row">
														<li class="weight-500 col-md-6"> 
															<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" name="nama_siswa" value="<?php echo $nama_siswa; ?>">
															</div>
															<div class="form-group">
																<label>Email</label>
...
<?php
		if (isset($_POST["Update"])) {
			...
			$keterangan = strip_tags($_POST["keterangan"]);
				...
				if ($ubah) {
					echo "<script>alert('Data $nama_siswa berhasil diubah !');document.location.href='?mnu=profile';</script>";
				} else {
					echo "<script>alert('Data $nama_siswa gagal diubah...');document.location.href='?mnu=profile';</script>";
				}
			} //else simpan
		?>